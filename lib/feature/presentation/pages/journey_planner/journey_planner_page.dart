  ...
  Widget build(BuildContext context) {
    ...
    return bloc.BlocListener<JourneyPlannerBloc, JourneyPlannerState>(
      listener: (context, state) {
        ...
        } else if (state is UploadVideoErrorState) {
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(left: _paddingContent,
                        right: _paddingContent,
                        top: _paddingContent),
                    child: SafeArea(
                      child: Column(
                              ...
                              Container(
                                ...
                                child: Text(
                                  _currentIndex == 0
                                      ...
                                      :
                                  _currentIndex == 1
                                      ? "It might take a minute after submitting a video to plan a journey_list."
                                      :
